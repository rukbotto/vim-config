" Base2Tone_SpaceDark (https://github.com/chriskempson/base16)
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/Base2Tone_SpaceDark.".&background.".sh"
  endif
endif
...
call <sid>hi("IncSearch",     s:gui01, s:gui06, s:cterm01, s:cterm06, "none")
...
call <sid>hi("Title",         s:gui0E, "", s:cterm0E, "", "none")
...
call <sid>hi("TabLineSel",    s:gui0D, s:gui00, s:cterm0D, s:cterm00, "none")
